...
export default function AssetManagementTable() {
  ...
  const allProjectMapping = useSelector(
    (state) => state.assetManagement?.assetMangementAll,
  );
          ...
          >
            <IconButton
              ...
              onClick={() => {
                setEditMode(true);
                setOpen(true);
                setSelectAssetObj(row?.original);
                setAssetID(row?.original.assetId);
  ...
  const deleteOrPhaseOuttheProject = () => {
    if (actionType == "delete") {
      dispatch(actions.deleteAssetManagement(assetID));
    } else {
      return;
    }
  };
      ...
      >
        ...
        <>
          ...
          <AddassetManagemnet
            ...
            selectAssetObj={selectAssetObj}
            setSelectAssetObj={setSelectAssetObj}
            assetID={assetID}
